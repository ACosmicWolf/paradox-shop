  ...
  return (
    <div className="hero-wrapper bg-center bg-no-repeat bg-cover flex flex-row items-center" style={{ backgroundImage: `url("data:image/svg+xml,${encodeURIComponent(svgCode)}")` }}>
      <div className="intro-wrap">
        <FadeInSection>
         <p className="hero-head font-bold  ">Paradox Shop</p>
          <p className="hero-head pl-8 pt-4 text-base">
            This is the shop which is all you need . We provide a variety of services
          </p> 
        </FadeInSection>
      </div>
        ...
        <div className="cards-wrap">
          ...
          <div className="card ">
            ...
            <div className="img go"></div> {/* NITRO IMAGE */} 
            <div className="btnBuynow go"> {/* BUY NOW BUTTON WILL GO  */}HERE 
